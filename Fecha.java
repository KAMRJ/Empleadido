...
public class Fecha
{
    ...
    public Fecha(String pFecha){
        dia = Integer.parseInt(pFecha.substring(0,2));
        mes = Integer.parseInt(pFecha.substring(3,5));
        anio = Integer.parseInt(pFecha.substring(6));
    }
    /**
    ...
    {
        return String.format("%02d/%02d/4%d", dia, mes, anio);
    }
}
